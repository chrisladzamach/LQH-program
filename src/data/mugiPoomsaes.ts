/*
FIGURA DE NUNCHAKUS 1
NOTA: Mientras no se especifique lo contrario, las transiciones entre posiciones de las figuras con I Chol Bong debes ser realizadas en Koap Sogi.

         *inicia con los Nunchakus horizontalmente rectos*
1.	10 derecha, 10 izquierda, 19 a la izquierda, ½ 19 a la derecha. Baja 6 y al subir 4, lanza por entre las piernas y saca por detrás con medio 6, 7, 7, 7, luego 9, 5 (cambiando de mano), 20, 20, 20 y 21. Nunchakus por derecha, cambia con 4 por izquierda y ejecuta 21 terminando en Koap Sogi. (Grito)
         *pone los Nunchakus rectos.
2.	A la cintura 4 veces empezando por izquierda con el palo invertido y arriba como 4 y vuelve a ejecutar 2 movimientos más a la cintura y 4 dos veces. 8, 13, 15 en diagonal y en Ap Kubi, cambia con 4 a mano izquierda y 13, 15. Cambia al lado derecho en Ap Kubi 8, 13, 15, cambia de mano con 4 y ejecuta 13, 15. En Koap Sogi, gira 3 veces por el cuello desde la mano derecha como 19 sin golpe, luego 3 veces por el otro lado. 19, 25, 22, 25, 22, 15. Engancha en la axila, agarra por la espalda el Nunchaku enganchado, con la mano izquierda, 13, devuelve el Nunchaku pegándole con la mano derecha y pone los Nunchakus rectos. (Grito).


FIGURA DE NUNCHAKUS 2
...
FIGURAS DE JANG BONG (FIGURA CON PALO LARGO)

FIGURA DE JANG BONG 1
...
FIGURA CON TANG BONG (PALO CORTO)
1. Empuña el mando en la mano derecha, hace un leve giro hacia la derecha con ambas manos juntas como el saludo de básico de respiración y empieza a mover lentamente sus brazos al frente. Recoge el pie izquierdo, gira sus brazos por dentro a la altura de los genitales. Levanta los talones y deja caer su cuerpo al lado izquierdo en Ap Kubi Sogi, a la vez que con la mano derecha hace Olgul Makki. Levanta la pierna derecha en Hak Dary Sogi, GeumGang Yop Jeumok. Deja caer la pierna a Ap Kubi Sogi, Dul Kwon Jeumok Chigi (der-izq). Avanza Dwip Kubi Sogi con el pie izquierdo adelante a la vez que hace Orum Dolt Sogi. Sin cambiar de posición GeumGang Yop Jeumok (Bloquea derecha), en esa misma posición pega codazo derecho (Uen Dolt Sogi) luego izquierdo. Recoge el pie izquierdo a Moap Sogi y Orum Dolt Sogi.
2 - Por el Callejón: Suelta el Tang Bong, y lo toma por la cuerda con el pulgar, gira por debajo hacia arriba y de izquierda a derecha, se devuelve de derecha a izquierda y los hace dos veces más, hasta que en el último giro coge la cuerda con el dedo corazón. Con el Bong tomado de la cuerda hace como #24 y 5 de Nunchakus, vuelve a empuñar el Tang Bong.  Cae En Orum Ap Kubi (diagonal) GeumGang Jeumok (bloquea derecha), con la pierna de atrás hace Ap Chagi cruzando con el brazo izquierdo al frente. Cae en Uen Ap Kubi Sogi, Son Nal GeumGang Jeumok (bloquea izquierda). Avanza en Orum Ap Kubi Sogi, Dul Kwon Montong Jeumok Chigi (der-izq). (grito)
3 - Dobla codo izquierdo y pega Orum Pal Kup a la vez que recoge pie izquierdo para pegar Uen Yop Chago Tora Yop Chagi y regresa atrás pie derecho con Montong Son Nal Goduro Makki en Dwip Kubi Sogi. Avanza en Orum Ap Kubi, Montong Batang Nullo Makki y chuza con el Tang Bong (como pyon Son Kup).
4 - Recoge el pie derecho y hace el paso 3 por el otro lado. (las patadas también son izq-der)
5 - Por el callejón de regreso: Levanta el pie derecho en Hak Dary Sogi punza con el Tang Bong arriba y Are Neryo Batang Makki. HAce un giro con la mano derecha y pega a las rodillas del oponente cayendo arrodillado. Gira por la espalda y levanta el pie izquierdo en Hak Dary Sogi, chuzando con el Tang Bong arriba a la vez que la otra mano acompaña al codo.
6 - Gira al lado izquierdo de frente y cae en ChumChum Sogi a la vez que pega codazos atrás derecho e izquierdo. Desplaza en Koap Sogi y Uen Dolt Sogi. Uen Yop Chagi. Cae sobre el pie iszquierdo y gira por el frente para pegar con el Tang Bong agarrado por ambas manos en Ap Kubi Sogi izquierdo. (grito)
Desplaza el pie derecho atrás en Dwip Kubi Sogi, Montong Son Nal Goduro Makki.
7 - Recoge el pie derecho y cambia a Uen Dwip Kubi Sogi pero de frente.
